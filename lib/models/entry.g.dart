...
const EntrySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'mood': PropertySchema(
      ...
      name: r'mood',
      type: IsarType.byte,
      enumMap: _EntrymoodEnumValueMap,
    ),
...
Entry _entryDeserialize(
  ...
  object.mood =
      _EntrymoodValueEnumMap[reader.readByteOrNull(offsets[3])] ?? Mood.happy;
...
P _entryDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (reader.readStringOrNull(offset)) as P;
    case 3:
      return (_EntrymoodValueEnumMap[reader.readByteOrNull(offset)] ??
          Mood.happy) as P;
    case 4:
      return (reader.readStringOrNull(offset)) as P;
    default:
...
extension EntryQueryFilter on QueryBuilder<Entry, Entry, QFilterCondition> {
  QueryBuilder<Entry, Entry, QAfterFilterCondition> contentIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> contentIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> dateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'date',
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> dateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> dateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> dateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> imagePathIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> imagePathIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'imagePath',
      ));
  ...
  QueryBuilder<Entry, Entry, QAfterFilterCondition> moodEqualTo(Mood value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'mood',
        value: value,
...
extension EntryQuerySortBy on QueryBuilder<Entry, Entry, QSortBy> {
  ...
  QueryBuilder<Entry, Entry, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EntryQuerySortThenBy on QueryBuilder<Entry, Entry, QSortThenBy> {
  ...
  QueryBuilder<Entry, Entry, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<Entry, Entry, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
...
extension EntryQueryWhereDistinct on QueryBuilder<Entry, Entry, QDistinct> {
  ...
  QueryBuilder<Entry, Entry, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension EntryQueryProperty on QueryBuilder<Entry, Entry, QQueryProperty> {
  ...
  QueryBuilder<Entry, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Entry, Mood, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
